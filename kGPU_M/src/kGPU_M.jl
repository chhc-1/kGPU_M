...
CPU_rfft_type32 = FFTW.rFFTWPlan{Float32, -1, false, 2, Tuple{Int32, Int32}};
CPU_rfft_type64 = FFTW.rFFTWPlan{Float64, -1, false, 2, Tuple{Int64, Int64}};
CPU_irfft_type32 = AbstractFFTs.ScaledPlan{ComplexF32, FFTW.rFFTWPlan{ComplexF32, 1, false, 2, UnitRange{Int32}}, Float32};
CPU_irfft_type64 = AbstractFFTs.ScaledPlan{ComplexF64, FFTW.rFFTWPlan{ComplexF64, 1, false, 2, UnitRange{Int64}}, Float64};

GPU_rfft_type32 = CUDA.CUFFT.CuFFTPlan{ComplexF32, Float32, -1, false, 2, 2, CUDA.CuArray{ComplexF32, 2, CUDA.DeviceMemory}};
